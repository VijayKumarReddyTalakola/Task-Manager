...
const Register = () => {
  ...
  return (
    <div className="w-screen flex flex-col items-center justify-center min-h-screen max-h-screen overflow-x-hidden">
      <div className="flex flex-row-reverse bg-white w-full rounded-lg shadow-2xl border-t-2 border-l-2 overflow-hidden mx-auto max-w-xs sm:max-w-sm lg:max-w-md">
